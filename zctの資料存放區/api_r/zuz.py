...
# API 2: 根據條件篩選歷史紀錄
@zuz.route('/filter_history', methods=['POST'])
def filter_history():
...
@zuz.route('/getLeaveRequests', methods=['GET'])
...
@zuz.route('/updateReviewStatus', methods=['POST'])
