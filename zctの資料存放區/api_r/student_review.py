...
student_review_bp = Blueprint('student_review', __name__)
...
# 查詢學生審查狀況
@student_review_bp.route('/getStudentReviews', methods=['GET'])
...
# 更新審查狀態
@student_review_bp.route('/updateReviewStatus', methods=['POST'])
...
# 查詢審查更新
@student_review_bp.route('/getReviewUpdates', methods=['GET'])
